...
Input data: `r report_var$config$input_file`
...
```
Each color represents a cluster of authors who are strongly connected within the network, highlighting the spread of the clusters within the network.
All nodes here are equal in size without reflecting any centrality metrics.  