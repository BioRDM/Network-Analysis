...
plot(graph, vertex_color = "cutpoint", layout = config$plot$layout, display_names = FALSE)
```
...
There are `r length(unique(igraph::V(graph$graph)$name[!is.na(igraph::V(graph$graph)$cutpoint)]))` cutpoint authors.
